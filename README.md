...
You can access all the data generated by this project by going to the [`data/`](data/) folder.
For example, you will find there files to see which genes belong to each latent variable (LV) and their weights, or which pathways are associated to each LV, etc.

Please carefully follow instructions for citations, since this project uses data generated by others.
