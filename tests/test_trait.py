...
class TraitTest(unittest.TestCase):
    ...
    def test_ukb_trait_category_cancer_selfreported_20001_gastrointestinal(self):
    ...
    def test_gtexgwas_trait_category_digestive(self):
        trait = GTEXGWASTrait(code='UKB_20002_1154_self_reported_irritable_bowel_syndrome')
        trait_cat = trait.category
        assert trait_cat is not None
    ...
    def test_ukb_trait_with_cases_and_controls(self):
        ...
        assert pheno_from_code.description == 'Diagnoses - main ICD10: G54 Nerve root and plexus disorders'
        ...
        assert pheno_from_code.source == 'UK Biobank'
        assert pheno_from_code.study == Study.UK_BIOBANK
        assert pheno_from_code.get_plain_name() == 'G54-Diagnoses_main_ICD10_G54_Nerve_root_and_plexus_disorders'
    ...
    def test_gtex_gwas_trait_with_cases_and_controls(self):
        pheno_from_code = GTEXGWASTrait(code='UKB_20002_1094_self_reported_deep_venous_thrombosis_dvt')
        assert pheno_from_code is not None
        assert pheno_from_code.code == 'UKB_20002_1094_self_reported_deep_venous_thrombosis_dvt'
        ...
        assert pheno_from_code.source == 'UK Biobank'
        assert pheno_from_code.study == Study.GTEX_GWAS
        assert pheno_from_code.get_plain_name() == 'UKB_20002_1094_self_reported_deep_venous_thrombosis_dvt'
