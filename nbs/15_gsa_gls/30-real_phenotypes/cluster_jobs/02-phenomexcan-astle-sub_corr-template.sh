...
# BSUB -cwd _tmp/phenoplier/phenomexcan
...
INPUT_SMULTIXCAN_DIR="${PHENOPLIER_PHENOMEXCAN_GENE_ASSOC_DIR}/smultixcan/gtex_gwas"
...
bash ${CODE_DIR}/01_gls_phenoplier.sh \
  --input-file ${INPUT_SMULTIXCAN_DIR}/${pheno_id}_smultixcan_imputed_gwas_gtexv8mashr_ccn30.txt.gz \
