...
OUTPUT_DIR="${PHENOPLIER_RESULTS_GLS_NULL_SIMS}/phenoplier/gls-1000g_mashr-test_lv45"
...
bash ${CODE_DIR}/01_gls_phenoplier.sh \
  ...
  --lv-list LV45 \
  --output-file ${OUTPUT_DIR}/random.pheno${pheno_id}-test_lv45-gls_phenoplier.tsv.gz
